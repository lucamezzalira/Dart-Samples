...
StyleSheet compile(var input, {List errors, List options, bool nested: false}) {
  ...
  analyze([tree], errors: errors, options: options, nested: nested);
...
void analyze(List<StyleSheet> styleSheets,  {List errors, List options,
  bool nested: false}) {
  _createMessages(errors: errors, options: options);
  new Analyzer(styleSheets, messages).run(nested: nested);
}
