...
$$.StreamController = {"": "EventSink;stream",
  ...
  add$1: function(_, value) {
    return this.stream._liblib8$_add$1(value);
  },
  $asEventSink: null
};
...
$$._StreamImpl = {"": "Stream;_state@",
  ...
  _liblib8$_add$1: function(value) {
  ...
  get$_liblib8$_add: function() {
    return new $.BoundClosure$1(this, "_liblib8$_add$1");
  },
...
$$._StreamSubscriptionImpl = {"": "_StreamListener;_cancelOnError<,_liblib8$_onData,_onError,_onDone,_source,_state,_nextLink,_previousLink",
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_cancelOnError<,_subscription@,_liblib8$_onData,_onError,_onDone",
  cancel$0: function() {
...
$$._WhereStream = {"": "_ForwardingStream;_test,_source",
  ...
  _handleData$2: function(inputEvent, sink) {
    ...
    if (satisfies === true)
      sink._liblib8$_onData$1(inputEvent);
  },
...
$$._MapStream = {"": "_ForwardingStream;_transform,_source",
  ...
  _handleData$2: function(inputEvent, sink) {
    ...
    sink._liblib8$_onData$1(outputEvent);
  },
...
$$._EventStreamSubscription = {"": "StreamSubscription;_liblib3$_pauseCount,_target,_eventType,_onData,_useCapture",
  cancel$0: function() {
...
$$.PathObserver = {"": "Object;object,path,_isValid,_values<,_valueStream,_observer,_lastObserver,_liblib3$_lastValue,_liblib3$_scheduled",
  ...
  _deliverValues$0: function() {
    ...
    if (t1 == null ? newValue != null : t1 !== newValue) {
      this._values.stream._liblib8$_add$1(newValue);
...
$$.CompoundBinding = {"": "ObservableBase;_combinator,_bindings,_values<,_liblib3$_scheduled,_disposed,_liblib3$_value,_observers,_liblib10$_stream,_changes",
...
$$.ObservableBase = {"": "Object+ObservableMixin;_observers,_liblib10$_stream,_changes", $isObservable: true};

$$.ObservableMixin = {"": "Object;",
  get$changes: function() {
    if (this._observers == null) {
      this._observers = $.StreamController$(null, null, null, null, [$.JSArray, $.ChangeRecord]);
      this._liblib10$_stream = this._observers.stream.asBroadcastStream$0();
    }
    return this._liblib10$_stream;
  },
  ...
  _deliverChanges$0: function() {
    ...
    if (this.get$hasObservers() && changes != null)
      this._observers.stream._liblib8$_add$1(changes);
  },
...
$$._AttributeClassSet = {"": "CssClassSetImpl;_liblib7$_element",
  readClasses$0: function() {
    ...
    classname = $.get$attributes$x(this._liblib7$_element)._element.getAttribute("class");
    s = $.LinkedHashSet$($.JSString);
    if (classname == null)
      return s;
...
$$.init_autogenerated_closure0 = {"": "Closure;__html0_1",
  call$3: function($$list, $$index, __t) {
    var t1, data, __e4, t2, t3, t4, __e3, __binding2;
    t1 = {};
    data = $.$index$asx($$list, $$index);
    t1.__e0_0 = null;
    t1.__e1_1 = null;
    __e4 = $.clone$1$x(this.__html0_1, true);
    t2 = $.getInterceptor$x(__e4);
    t3 = t2.get$nodes(__e4)._this.childNodes;
    if (1 >= t3.length)
      throw $.ioore(1);
    t1.__e0_0 = t3[1];
    __t.listen$2($.get$onClick$x(t1.__e0_0), new $.init_autogenerated__closure());
    __t.listen$2($.get$onLoad$x(t1.__e0_0), new $.init_autogenerated__closure0());
    __t.listen$2($.get$onMouseOut$x(t1.__e0_0), new $.init_autogenerated__closure1());
    __t.listen$2($.get$onMouseOver$x(t1.__e0_0), new $.init_autogenerated__closure2());
    t3 = $.getInterceptor$x(__t);
    t3.bind$3(__t, new $.init_autogenerated__closure3(data), new $.init_autogenerated__closure4(t1), false);
    __t.oneWayBind$4(new $.init_autogenerated__closure5(data), new $.init_autogenerated__closure6(t1), false, true);
    t4 = t2.get$nodes(__e4)._this.childNodes;
    if (3 >= t4.length)
      throw $.ioore(3);
    t1.__e1_1 = t4[3];
    t3.bind$3(__t, new $.init_autogenerated__closure7(data), new $.init_autogenerated__closure8(t1), false);
    t2 = t2.get$nodes(__e4)._this.childNodes;
    if (5 >= t2.length)
      throw $.ioore(5);
    __e3 = $.$index$asx($.get$nodes$x(t2[5]), 0);
    __binding2 = __t.contentBind$2(new $.init_autogenerated__closure9(data), false);
...
$$.init_autogenerated__closure0 = {"": "Closure;",
  call$1: function($$event) {
    var id, img, t1;
    id = $.JSString_methods.$add("#", $.get$id$x($.get$target$x($$event)));
    img = $.HtmlDocument_methods.queryAll$1(document, id);
    t1 = img.get$classes(img);
    t1.remove$1(t1, "faded");
    t1 = img.get$classes(img);
    t1.add$1(t1, "fade-in");
  },
  $isFunction: true
...
$$.init_autogenerated__closure3 = {"": "Closure;data_2",
  call$0: function() {
    return $.$index$asx(this.data_2, 0);
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure4 = {"": "Closure;box_0",
  call$1: function(__e) {
    $.set$id$x(this.box_0.__e0_0, "img_" + $.S($.get$newValue$x(__e)));
  },
  $isFunction: true
};

$$.init_autogenerated__closure5 = {"": "Closure;data_3",
  call$0: function() {
    return $.$index$asx(this.data_3, 1);
  },
  $isFunction: true
};

$$.init_autogenerated__closure6 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$src$x(t1.__e0_0), e) !== true)
      $.set$src$x(t1.__e0_0, e);
  },
  $isFunction: true
};

$$.init_autogenerated__closure7 = {"": "Closure;data_4",
  call$0: function() {
    return $.$index$asx(this.data_4, 0);
  },
  $isFunction: true
};
...
$$.init_autogenerated__closure8 = {"": "Closure;box_0",
  call$1: function(__e) {
    $.set$id$x(this.box_0.__e1_1, "zoom_" + $.S($.get$newValue$x(__e)));
  },
  $isFunction: true
};

$$.init_autogenerated__closure9 = {"": "Closure;data_5",
  call$0: function() {
    return $.$index$asx(this.data_5, 2);
  },
  $isFunction: true
};
...
$$.LinkedListNode = {"": "Object;_previous?,_next?,_list<,_liblib0$_value",
  ...
  append$1: function(_, e) {
    return $.LinkedListNode$_(e, this._list, $.getRuntimeTypeArgument(this, this.$asLinkedListNode, 0))._link$2(this, this._next);
  },
  remove$0: function(_) {
    var t1, t2;
    t1 = this._list;
...
$$.Listener = {"": "TemplateItem;eventStream,_liblib9$_subscription,listener",
  insert$0: function(_) {
    var t1 = this.eventStream;
    this._liblib9$_subscription = $._EventStreamSubscription$(t1._target, t1._eventType, this.listener, t1._useCapture);
  },
  remove$0: function(_) {
...
$$.Element = {"": "Node;_templateIterator%,_templateInstanceRef},_templateContent},_templateIsDecorated%,$$dom_children:children=,id%,innerHtml:innerHTML},$$dom_className:className%,tagName=",
  ...
  createInstance$0: function(receiver) {
    ...
    if (t1 != null)
      t1.stream._liblib8$_add$1(instance);
    return instance;
  },
...
$$.InputElement = {"": "Element;_checkedBinding=,form=,height},src%,type=,value%,width}",
  bind$3: function(receiver, $name, model, path) {
    var t1;
    switch ($name) {
      case "value":
...
$$.ObjectElement = {"": "Element;form=,height},type=,width}"};
  ...
  if (typeof clone === "object" && clone !== null && !!$.getInterceptor(clone).$isElement && $.get$isTemplate$x(clone)) {
    ...
    if (syntax != null) {
      ...
      if (t2.containsKey$1("syntax") !== true)
        t2.$indexSet(t2, "syntax", new $._createDeepCloneAndDecorateTemplates_closure(syntax).call$0());
      t2.$index(t2, "syntax");
    }
  }
  for (c = t1.get$$$dom_firstChild(node); c != null; c = c.nextSibling)
    clone.appendChild($._createDeepCloneAndDecorateTemplates(c, syntax));
  return clone;
};
...
$._liftNonNativeTemplateChildrenIntoContent = function(templateElement) {
  ...
  for (; child = t1.get$$$dom_firstChild(templateElement), child != null;)
...
$._addBindings = function(node, model, syntax) {
  ...
  for (c = $.get$$$dom_firstChild$x(node); c != null; c = c.nextSibling)
    $._addBindings(c, model, syntax);
};

$._addAttributeBindings = function(element, model, syntax) {
  var t1 = $.get$attributes$x(element);
  t1.forEach$1(t1, new $._addAttributeBindings_closure(element, model, syntax));
};
...
$.onOver = function($event) {
  var t1, zoom, t2;
  t1 = $.JSString_methods.$add("#zoom_", $.$index$asx($.get$id$x($.get$target$x($event)), 4));
  zoom = document.querySelector(t1);
  t1 = $.getInterceptor$x(zoom);
  t2 = t1.get$classes(zoom);
  t2.remove$1(t2, "fade-out");
  t1 = t1.get$classes(zoom);
  t1.add$1(t1, "fade-in");
};
...
$.onOut = function($event) {
  ...
  t1 = $.getInterceptor$x(zoom);
  t2 = t1.get$classes(zoom);
  t2.remove$1(t2, "fade-in");
  t1 = t1.get$classes(zoom);
  t1.add$1(t1, "fade-out");
};

$.onClick = function($event) {
  var t1;
  $.zoomImg = $.ImageElement_ImageElement(null, "images/" + $.S($.$index$asx($.get$id$x($.get$target$x($event)), 4)) + ".JPG", null);
  t1 = $.get$onLoad$x($.zoomImg);
  $._EventStreamSubscription$(t1._target, t1._eventType, $.showBigImg, t1._useCapture);
  $.bg = document.createElement("div");
  t1 = $.get$classes$x($.bg);
  t1.add$1(t1, "black_overlay");
  $.cont = document.createElement("div");
  t1 = $.get$children$x($.cont);
  t1.add$1(t1, $.zoomImg);
  t1 = $.get$classes$x($.cont);
  t1.add$1(t1, "bigImage");
  t1 = $.get$onClick$x($.cont);
  $._EventStreamSubscription$(t1._target, t1._eventType, $.closePopUp, t1._useCapture);
  $.get$children$x(document.body)._element.appendChild($.bg);
  $.get$children$x(document.body)._element.appendChild($.cont);
};

$.showBigImg = function($event) {
  $.set$opacity$x($.bg.style, ".7");
  $.set$transition$x($.bg.style, "1s");
  $.set$opacity$x($.cont.style, "1");
  $.set$transition$x($.cont.style, "1s");
};

$.closePopUp = function($event) {
  var milliseconds;
  $.set$opacity$x($.cont.style, "0");
  $.set$transition$x($.cont.style, "1s");
  $.set$opacity$x($.bg.style, "0");
  $.set$transition$x($.bg.style, "1s");
  milliseconds = $.Duration$(0, 0, 0, 0, 0, 1).get$inMilliseconds();
  if (milliseconds < 0)
    milliseconds = 0;
  $.TimerImpl$(milliseconds, new $.closePopUp_closure());
};

$.init_autogenerated = function() {
  var __root, __html0, __t, t1;
  __root = document.body;
  __html0 = $._ElementFactoryProvider_createElement_html("<div class=\"image\">\n          <img class=\"faded\" width=\"320\" height=\"240\">\n          <img src=\"images/zoom.png\" class=\"zoom\">\n          <h2><span></span></h2>\n         </div>");
  __t = $.Template$(__root);
  t1 = $.get$nodes$x(__root)._this.childNodes;
  if (3 >= t1.length)
    throw $.ioore(3);
  __t.children.push($.LoopTemplate$($.$index$asx($.get$nodes$x(t1[3]), 1), new $.init_autogenerated_closure(), new $.init_autogenerated_closure0(__html0)));
  __t.create$0();
  __t.insert$0(__t);
};
...
$.showBigImg.call$1 = $.showBigImg;
$.showBigImg.$name = "showBigImg";
$.closePopUp.call$1 = $.closePopUp;
...
Isolate.$lazy($, "images", "images", "get$images", function() {
  return [["1", "images/1.JPG", "custom text 1"], ["2", "images/2.JPG", "custom text 2"], ["3", "images/3.JPG", "custom text 3"], ["4", "images/4.JPG", "custom text 4"], ["5", "images/5.JPG", "custom text 5"], ["6", "images/6.JPG", "custom text 6"], ["7", "images/7.JPG", "custom text 7"], ["8", "images/8.JPG", "custom text 8"], ["9", "images/9.JPG", "custom text 9"]];
});
// Native classes
...
//@ sourceMappingURL=imagegallery.html_bootstrap.dart.js.map
